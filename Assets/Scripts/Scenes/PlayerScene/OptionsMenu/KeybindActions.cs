...
public class KeybindActions : NetworkBehaviour
{
    ...
    public void StartRebindingComposit( InputAction action, TextMeshProUGUI textKeybind, int index )
    {
    ...
    public void StartRebinding(InputAction action, TextMeshProUGUI textKeybind )
    {
        if(!startRebindObject) {
    ...
    private void RebindComplete( InputAction action, TextMeshProUGUI textKeybind )
    {
    ...
    private void RebindCompleteComposit( InputAction action, TextMeshProUGUI textKeybind, int index )
    {
    ...
    public void LoadKeybindsText( InputAction action, TextMeshProUGUI textKeybind )
    {
    ...
    public void LoadKeybindsTextComposit( InputAction action, TextMeshProUGUI textKeybind, int index )
    {
        textKeybind.text = InputControlPath.ToHumanReadableString(
    ...
    public void LoadKeybindsCameraInverted( TextMeshProUGUI textKeybind )
    {
    ...
    public void LoadKeybindsCameraInverted( TextMeshProUGUI textKeybind, int inverted )
    {
        if(inverted == 1) {
            textKeybind.text = "Default";
        }
    ...
    public void ChangeCameraInverted( TextMeshProUGUI textKeybind )
    {
